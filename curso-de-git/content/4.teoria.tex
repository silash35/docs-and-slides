...
\begin{frame}{O que são tags?}
  ...
  \note{
    ...
    Ela é usada principalmente para marcar versões importantes do projeto, como uma versão de lançamento. Diferentemente de uma branch, uma tag não representa uma linha de desenvolvimento.
  }
\end{frame}
...
\begin{frame}{O fluxo de trabalho do Git}
  ...
  \note{
    ...
    Esse tal de Remote Repository pode ser o GitHub, o GitLab ou qualquer outra plataforma que você estiver usando.
